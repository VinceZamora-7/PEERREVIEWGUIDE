  ...
  <tr>
    <td align="center">
      <table width="1000" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
        ...
        <tr>
          <td align="right" bgcolor="#FFFFFF" style="padding:20px;font-size:9pt;color:#000000>
        ...
        <tr>
          <td style="color:#071952; font-size:25pt; padding:5px 20px; font-weight:600" align="center">Feedback Received</td>
        </tr>
        <tr>
          <td style="padding:30px 40px 10px 40px; color:#000000; font-size:12pt">
            ...
            <p style="font-size:14pt"><strong>' . $taskNameShort . '</strong><br/><span style="font-size:12pt">PRID: <a href=https://eventsprguide.infinityfree.me/pr-feedback/pr_feedback.php?pr_id=' . urlencode($pr_id) .' target="_blank"> '.htmlspecialchars($pr_id) . '</a></span></p>
          </td>
        </tr>
        <tr>
...
foreach ($questions as $qid => $qText) {
    ...
    if (isset($answers[$answerKey]) && strtolower($answers[$answerKey]) === 'applicable') {
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" 
                    ...
                    <tr>
                        <td style="padding:20px; font-family:Arial, sans-serif; font-size:12pt; color:#000000;">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td><strong>Question:</strong></td> <td>' . htmlspecialchars($qText) . '</td>
                            </tr>
                            <tr>
                              <td><strong>Answer:</strong></td> <td>'. htmlspecialchars($answers[$answerKey]) . '</td>
                            </tr>';
        ...
        $emailBody .= '<tr>
                        <td><strong>Fatality:</strong></td> <td>' . $fatality_display . '</td>
                      </tr>';
        ...
        $emailBody .= '<tr>
                        <td><strong>Remarks:</strong></td> <td>' . htmlspecialchars($remarks) . '</td>
                      </tr>
                      </table>';
...
<a href="https://yourdomain.com/appeal" style="color:#fff; text-decoration:none;">Appeal</a>
</td>
<td width="15%">&nbsp;</td>
</tr>
</table>
...
<tr><td>&nbsp;</td></tr><tr><td align="center"><img src="https://eventsprguide.infinityfree.me/img/botBG.png" width="100%" alt="Logo"/></td></tr>
</table>
</td></tr></table>
</body></html>';
...
try {
    ...
    // Log failure
    $errorMessage = "Email could not be sent. PHPMailer Error: {$mail->ErrorInfo}. Exception: {$e->getMessage()}\n";
    file_put_contents(__DIR__ . '/email_debug.log', "[".date('Y-m-d H:i:s')."] $errorMessage", FILE_APPEND);
    ...
    if (isset($_POST['ajax'])) {
        ...
        echo json_encode([
            ...
            'debug' => ['phpmailer_error' => $mail->ErrorInfo, 'exception_message' => $e->getMessage()]
        ]);
    } else {
        echo $errorMessage;
    }
